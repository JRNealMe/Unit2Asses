...
function canWeDeliver(deliveryAraZipCodes);{
    if (deliveryAraZipCodes = true) {
    console.log ('You are in our deliver zone')
        }    else { 
...
const canWeDeliverTwo = (zipcode) => {
    ...
    return "Apologies, we do not deliver to this area"
}
...
var monthlyDeal = ['15% Off'];
monthlyDeal['10% off'] = 'updatedOffer';
...
deals[1].desc = deal[1].desc.replace('march', 'april').trim()
console.log(deals)